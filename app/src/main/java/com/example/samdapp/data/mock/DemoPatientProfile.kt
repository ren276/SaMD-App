...
object DemoPatientProfile {
    ...
    private val OBESITY = Persona(
        ...
        symptomOnset = "Insidious (weeks to months)",
        durationBucket = "month_plus",
        severityScore = 3,
    ...
    private val HYPERTENSION = Persona(
        ...
        symptomOnset = "Gradual (days to weeks)",
        durationBucket = "week_plus",
        severityScore = 4,
        aggravatingFactors = "Stress, salty food, hot weather; worse in the mornings",
    ...
    private val TYPHOID = Persona(
        ...
        severityScore = 6,
        aggravatingFactors = "Evenings, physical exertion; fever stepwise rising each evening since onset",
    ...
    private val DENGUE = Persona(
        ...
        durationBucket = "few_days",
        severityScore = 8,
        aggravatingFactors = "Any exertion, lying flat; bleeding gums and breathlessness from day 4",
    ...
    private val PEDIATRIC_UTI = Persona(
        ...
        durationBucket = "few_days",
        severityScore = 4,
        aggravatingFactors = "Urination, drinking less water; noticed crying while urinating",
