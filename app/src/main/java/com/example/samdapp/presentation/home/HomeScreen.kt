...
fun HomeScreen(
    ...
    HomeContent(uiState = uiState, onRegisterNewPatient = onRegisterNewPatient, onOpenPatient = onOpenPatient)
}

@Composable
private fun HomeContent(uiState: HomeUiState, onRegisterNewPatient: () -> Unit, onOpenPatient: (String) -> Unit) {
