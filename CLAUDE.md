...
- `docs/domain/phc-workforce-scope.md` is the source of truth for PHC cadre scope of practice
  (physician/CHO, licensed clinical staff, community tier). The `UserRole` model and any future
  document-visibility gate over interpretive clinical content must key off cadre scope, not a
  flat worker/doctor flag.
