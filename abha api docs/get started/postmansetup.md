...
Download ABDM API Collection and extract the files from zip. .ico-download.svg
...
after_collection_import.png

Sample List of collections

sample_collection_list.png
